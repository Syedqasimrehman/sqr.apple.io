...
animateWithGsap('#features_titles ' , {opacity : 1 , y:0})
animateWithGsap(
  '.g_grow',
    ...
    overflow-hidden">
      <div className="screen-max-width">
        <div className="mb-12 w-full">
          <h1 id="features_titles" className="section-heading">
        ...
        items-center overflow-hidden">
          ...
          <div className="flex-center flex-col sm:px-10">
            <div className="relative h-[50vh] w-full
             flex item-center">
              <video playsInline autoPlay muted  id="exploreVideo" 
              className="w-full h-full object-cover 
              object-center" preload="none" ref={videoRef}>
            ...
            <div className="feature-text-container">
              ...
              <div className="flex-1 flex-center">
                <p className="feature-text g_text">
                  ...
                  You'll notice the dufference the moment you pick one up.
                </p>
              </div>
